...
percent_off_target = .025; % written as percentage 

% train model parameters  
max_iterations = 5*10^4;
Number_of_Nucleotides = 32;
use_old = 1;
off_target_weight = .01; % the error from off targeting will be worth 1/10 of the true data
